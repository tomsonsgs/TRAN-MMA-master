...
class WikiSqlSelectColumnAction(GenTokenAction):
    ...
    def __eq__(self, other):
        return isinstance(other, WikiSqlSelectColumnAction) and self.token == other.token
...
#    print(stmt_prod)
    ...
    stmt_node = AbstractSyntaxTree(stmt_prod, [col_idx_field, agg_op_field, condition_fields])
